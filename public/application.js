...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"col-sm-3 playlist-box\">\n    <h2 data-id=\""
  ...
  return "\n        Description:"
    ...
    + "\n        "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.songs : stack1), depth0))
    + "\n";
  ...
  return "    <h5 data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <li>\n        <h5>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.title : stack1),{"name":"if","hash":{},"fn":container.program(7, data, 0, blockParams),"inverse":container.program(9, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "        </h5>\n      </li>\n      <li>\n        <button  class=\"delete-song btn btn-danger\">Delete Song</button>\n      </li>\n    </ul>\n";
},"7":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "          Artist:"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.artist : stack1), depth0))
    + "\n          Album:"
  ...
  return ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.playlists : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.songs : depth0),{"name":"each","hash":{},"fn":container.program(6, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n\n<!-- *Matt*\nUser must not see update/delete if they dont own the playlist\n\nERD\n`Playlist has_many Songs`\n`Song belongs_to Playlist`\n\nUser Stories\n- User must be able to create a Song assigned to a Playlist\n- User must be able to delete a Song\n- User deletes a Playlist, its Songs should be deleted\nViews\n- New Song form underneath Playlist Delete button\n- Song form must have fields for title, artist, and album\n- Songs listed underneath New Song form\n- Each Song has a title, artist, album, and Delete button -->\n";
...
var playlistEvents = __webpack_require__(9);
...
var createPlaylist = function createPlaylist(event) {
  ...
  api.createPlaylistSubmit(data).then(ui.createPlaylistSuccess).catch(ui.createPlaylistError);
...
var createSong = function createSong(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createSongSubmit(data).then(ui.createSongSuccess).catch(ui.createSongError);
  $(event.target).trigger('reset');
};

var getSong = function getSong(event) {
  event.preventDefault();
  api.getSongSubmit().then(ui.getSongSuccess).catch(ui.getSongError);
};

var deleteSong = function deleteSong(event) {
  event.preventDefault();
  var playlistId = $(event.target).closest('ul').attr('data-id');
  api.deleteSongSubmit(playlistId).then(ui.deleteSongSuccess).catch(ui.deleteSongError);
};
...
// Song starts
var createSongSubmit = function createSongSubmit(data) {
  return $.ajax({
    method: 'POST',
...
var getSongSubmit = function getSongSubmit() {
  return $.ajax({
    method: 'GET',
    url: 'https://thawing-hamlet-16855.herokuapp.com/songs/',
    headers: {
...
var deleteSongSubmit = function deleteSongSubmit(songId) {
  return $.ajax({
...
// Song starts
var createSongSuccess = function createSongSuccess(response) {
  $('#content').html('');
  $('#display').html('Song created successfully!');
};

var createSongError = function createSongError(error) {
  $('#display').html('Song creation unsuccessful', error);
};

var getSongSuccess = function getSongSuccess(data) {
  $('#display').html('Songs retrieved successfully!');
  var showSongsHtml = handlebars({ songs: data.songs });
  $('.song-content').html(showSongsHtml);
  return data;
};

var getSongError = function getSongError(error) {
  $('#display').html('Song retrieval unsuccessful', error);
};

var deleteSongSuccess = function deleteSongSuccess(songId) {
  $('#display').html('Song deleted successfully!');
  $('#content').html('');
};

var deleteSongError = function deleteSongError(error) {
